...
vuelos.reservarVueloCarga = (request, response) => {
                    ...
                    pool.query(`UPDATE vuelos_carga SET ${portModify} = (${portModify} - 1) WHERE ?`, { id_vuelo: idVuelo }, (error, results) => {
                        if (error) {
                            ...
                            let mailOpts = {
                                ...
                                html: datosCorreo(idVuelo, nombreComp, port, peso, cost, nombreContact, emailContact, telContact)
                            }
    ...
    function datosCorreo(idVuelo, nombreComp, port, peso, cost, nombreContact, emailContact, telContact){
        return `
        <link rel="preconnect" href="https://fonts.googleapis.com">
        <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
        <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@300&display=swap" rel="stylesheet">
    
        <h1 style="background-color: #6699FF; color: white; padding:36px 48px;display:block; font-family: 'Montserrat', sans-serif;font-size:30px;font-weight:300;line-height:150%;margin:0;">Reserva de vuelo confirmada</h1>
        ...
        <h2 style="color: #6699FF; font-family: 'Montserrat', sans-serif;">Reserva</h2>
        ...
        <p>
            ...
            Si desea cancelar su reserva pinche <a href="#">aquí</a>
        </p>
